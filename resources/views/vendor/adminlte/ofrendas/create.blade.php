...
@section('title','Crear Nueva Ofrenda')
@section('content_header','Crear Nueva Ofrenda')
@section('content_description','Registra la información de la ofrenda')
    ...
    <div class="col-md-9">
      <div class="box box-primary">
        ...
        <div class="box-header with-border box-header-color">
          <h3 class="box-title">Registrar Información | Ofrenda</h3>
        </div>

        <div class="box-body">
          <div class="form-container">

            <form action="{{ route('ofrendas.store') }}" method="POST">
              ...
              <div class="form-button">
                <button type="submit" class="btn btn-primary">Guardar Ofrenda</button>
              </div>
