...
@section('title','Perfil de la Ofrenda')
@section('content_header', 'Ofrenda Nº'.$ofrenda->id)
@section('content_description','Muestra la información de la ofrenda')
    ...
    <div class="col-md-9">
      <div class="box box-primary">
        ...
        <div class="box-header with-border box-header-color">
          <h3 class="box-title">Información | Ofrenda</h3>
        </div>
        ...
        <div class="box-body">
          ...
          <strong>Monto</strong>
          <p class="text-muted">
          {!! number_format($ofrenda->monto, 0, ',', '.') ? nl2br(e(number_format($ofrenda->monto, 0, ',', '.'))) : 'No tiene monto' !!}
          </p>
          <hr class="hr-profile">
          ...
          <p class="text-muted">
          {!! $ofrenda->observation ? nl2br(e($ofrenda->observation)) : 'No tiene observaciones' !!}
          </p> 
          <hr class="hr-profile">

          <br \><br \>
          <div class="form-button button-submit-form col-sm-12">
              <a href="{{ route('ofrendas.index') }}" class="btn btn-primary">Salir</a>
          </div>
