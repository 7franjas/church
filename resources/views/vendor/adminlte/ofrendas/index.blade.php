...
@section('title','Administrar Ofrendas')
@section('content_header','Administrar Ofrendas')
@section('content_description','Almacena las ofrendas registradas')
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-header">
          ...
          <h4 class="modal-title">Eliminar Ofrenda</h4>
        </div>
        <div class="modal-body">
          <p>¿Está seguro de eliminar Ofrenda <b><span id="name-destroy"></span></b>?</p>
        </div>
