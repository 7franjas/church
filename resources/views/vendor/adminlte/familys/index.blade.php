...
@section('title','Administrar Familia')
@section('content_header','Administrar Familia')
@section('content_description','Almacena los familia registrados')
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <p>¿Está seguro de eliminar familia <b><span id="name-destroy"></span></b>?</p>
        </div>
...
<script>
  ...
  function modalDestroy(event, id, name) {
    ...
    $("#modal-destroy #name-destroy").html(name);
    // show modal
  ...
  $('#submitDestroy').click(function(){
    ...
    ajax_destroy = 'familys/destroy';
    id_family = $("#modal-destroy #id-destroy").val();
    ...
    $.ajax({
      url: ajax_destroy,
      type: 'POST',
      data: {'_token': '{{ csrf_token() }}', '_method': 'DELETE', 'id': id_family},
      success: function (data) {
          ...
          if(data.success == 'ok'){
            ...
            toastr.success('Se ha eliminado el usuario '+data.family);
          }
      }
    });
