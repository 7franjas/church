...
@section('title','Modificar Familia')
@section('content_header','Modificar Familia')
@section('content_description','Modificar la información de la familia')
    ...
    <div class="col-md-9">
      <div class="box box-primary">
        ...
        <div class="box-header with-border box-header-color">
          <h3 class="box-title">Modificar Información | Familia</h3>
        </div>

        <div class="box-body">
          <div class="form-container">

            <form action="{{ route('familys.update', $family->id) }}" method="POST">
              ...
              <div class="field {{ $errors->has('fam_name') ? 'has-error' : '' }}">
                <div class="input-group">
                  <input id="fam_name" name="fam_name" type="text" class="form-control form-data" placeholder="Familia" value="{{ $family->fam_name }}" autofocus="autofocus">
              ...
              <div class="field {{ $errors->has('fam_observation') ? 'has-error' : '' }}">
                <div class="input-group">
                  <textarea id="fam_observation" name="fam_observation" type="text" class="form-control form-data" placeholder="Observaciones" value="{{ $family->fam_observation }}">{{ $family->fam_observation }}</textarea>
