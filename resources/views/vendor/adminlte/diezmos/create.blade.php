...
@section('title','Crear Nuevo Diezmo')
@section('content_header','Crear Nuevo Diezmo')
@section('content_description','Registra la información del diezmo')
    ...
    <div class="col-md-9">
      <div class="box box-primary">
        ...
        <div class="box-header with-border box-header-color">
          <h3 class="box-title">Registrar Información | Diezmo</h3>
        </div>

        <div class="box-body">
          <div class="form-container">

            <form action="{{ route('diezmos.store') }}" method="POST">
              ...
              <div class="form-button">
                <button type="submit" class="btn btn-primary">Guardar Diezmo</button>
              </div>
