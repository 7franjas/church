...
@section('title','Perfil del Diezmo')
@section('content_header', 'Diezmo Nº'.$diezmo->id)
@section('content_description','Muestra la información del diezmo')
    ...
    <div class="col-md-9">
      <div class="box box-primary">
        ...
        <div class="box-header with-border box-header-color">
          <h3 class="box-title">Información | Diezmo</h3>
        </div>
        ...
        <div class="box-body">
          ...
          <strong>Monto</strong>
          <p class="text-muted">
          {!! number_format($diezmo->monto, 0, ',', '.') ? nl2br(e(number_format($diezmo->monto, 0, ',', '.'))) : 'No tiene monto' !!}
          </p>
          <hr class="hr-profile">
          ...
          <p class="text-muted">
          {!! $diezmo->observation ? nl2br(e($diezmo->observation)) : 'No tiene observaciones' !!}
          </p> 
          <hr class="hr-profile">

          <br \><br \>
          <div class="form-button button-submit-form col-sm-12">
              <a href="{{ route('diezmos.index') }}" class="btn btn-primary">Salir</a>
          </div>
