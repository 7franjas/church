...
@section('title','Administrar Egresos')
@section('content_header','Administrar Egresos')
@section('content_description','Almacena los egresos registrados')
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <p>¿Está seguro de eliminar Egreso <b><span id="name-destroy"></span></b>?</p>
        </div>
...
<script>
  ...
  $('#submitDestroy').click(function(){
    ...
    ajax_destroy = 'egresos/destroy';
    id_egreso = $("#modal-destroy #id-destroy").val();
    ...
    $.ajax({
      url: ajax_destroy,
      type: 'POST',
      data: {'_token': '{{ csrf_token() }}', '_method': 'DELETE', 'id': id_egreso},
      success: function (data) {
          ...
          if(data.success == 'ok'){
            ...
            toastr.success('Se ha eliminado el egreso '+data.id);
          }
      }
    });
