...
@section('content_header','Administrar Usuarios')
@section('content_description','Almacena los usuarios registrados')
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <p>¿Está seguro de eliminar el usuario <b><span id="name-destroy"></span></b>?</p>
        </div>
...
<script>
    ...
    $('#submitDestroy').click(function(){
      ...
      ajax_destroy = 'users/destroy';
      id_user = $("#modal-destroy #id-destroy").val();
      ...
      $.ajax({
        url: ajax_destroy,
        type: 'POST',
        data: {'_token': '{{ csrf_token() }}', '_method': 'DELETE', 'id': id_user},
        success: function (data) {
            ...
            if(data.success == 'ok'){
              ...
              toastr.success('Se ha eliminado el usuario '+data.user);
            }
        }
      });
