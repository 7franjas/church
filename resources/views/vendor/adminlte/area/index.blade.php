...
@section('title','Administrar Area')
@section('content_header','Administrar Area')
@section('content_description','Almacena las areas registradas')
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <p>¿Está seguro de eliminar área <b><span id="name-destroy"></span></b>?</p>
        </div>
...
<script>
  ...
  function modalDestroy(event, id, area) {
    // set parameters
    $("#modal-destroy #id-destroy").val(id);
    $("#modal-destroy #name-destroy").html(area);
    // show modal
  ...
  $('#submitDestroy').click(function(){
    ...
    ajax_destroy = 'area/destroy';
    id_area = $("#modal-destroy #id-destroy").val();
    ...
    $.ajax({
      url: ajax_destroy,
      type: 'POST',
      data: {'_token': '{{ csrf_token() }}', '_method': 'DELETE', 'id': id_area},
      success: function (data) {
          ...
          if(data.success == 'ok'){
            ...
            toastr.success('Se ha eliminado el area '+data.area);
          }
      }
    });
