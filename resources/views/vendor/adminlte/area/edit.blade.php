...
@section('content_header','Modificar Área')
@section('content_description','Modificar la información del área')
    ...
    <div class="col-md-9">
      <div class="box box-primary">
        ...
        <div class="box-header with-border box-header-color">
          <h3 class="box-title">Modificar Información | Área</h3>
        </div>
            ...
            <form action="{{ route('area.update', $area->id) }}" method="POST">
              ...
              <div class="field {{ $errors->has('area') ? 'has-error' : '' }}">
                <div class="input-group">
                  <input id="area" name="area" type="text" class="form-control form-data" placeholder="Área" value="{{ $area->area }}" autofocus="autofocus">
              ...
              <div class="field {{ $errors->has('description') ? 'has-error' : '' }}">
                <div class="input-group">
                  <input id="description" name="description" type="description" class="form-control form-data" placeholder="Descripción" value="{{ $area->description }}">
              ...
              <div class="field {{ $errors->has('observation') ? 'has-error' : '' }}">
                <div class="input-group">
                  <textarea id="observation" name="observation" type="text" class="form-control form-data" placeholder="Observaciones" value="{{ $area->observation }}">{{ $area->observation }}</textarea>
              ...
              <div class="form-button">
                <button type="submit" class="btn btn-primary">Modificar Área</button>
              </div>
