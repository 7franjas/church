...
@section('title','Crear Nueva Subarea')
@section('content_header','Crear Nueva Subarea')
@section('content_description','Registra la información de la subarea')
    ...
    <div class="col-md-9">
      <div class="box box-primary">
        ...
        <div class="box-header with-border box-header-color">
          <h3 class="box-title">Registrar Información | Subarea</h3>
        </div>
            ...
            <form action="{{ route('subarea.store') }}" method="POST">
              ...
              <div class="field {{ $errors->has('subarea') ? 'has-error' : '' }}">
                <div class="input-group">
                  <input id="subarea" name="subarea" type="text" class="form-control form-data" placeholder="Subarea" value="{{ old('subarea') }}" autofocus="autofocus">
              ...
              <div class="field {{ $errors->has('description') ? 'has-error' : '' }}">
                <div class="input-group">
                  <input id="description" name="description" type="text" class="form-control form-data" placeholder="Descripción" value="{{ old('description') }}">
              ...
              <div class="form-button">
                <button type="submit" class="btn btn-primary">Crear Subarea</button>
              </div>
