...
@section('title','Administrar Subarea')
@section('content_header','Administrar Subarea')
@section('content_description','Almacena las subareas registradas')
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-header">
          ...
          <h4 class="modal-title">Eliminar Subarea</h4>
        </div>
        <div class="modal-body">
          <p>¿Está seguro de eliminar subarea <b><span id="name-destroy"></span></b>?</p>
        </div>
...
<script>
  ...
  function modalDestroy(event, id, subarea) {
    // set parameters
    $("#modal-destroy #id-destroy").val(id);
    $("#modal-destroy #name-destroy").html(subarea);
    // show modal
  ...
  $('#submitDestroy').click(function(){
    ...
    ajax_destroy = 'subarea/destroy';
    id_subarea = $("#modal-destroy #id-destroy").val();
    ...
    $.ajax({
      url: ajax_destroy,
      type: 'POST',
      data: {'_token': '{{ csrf_token() }}', '_method': 'DELETE', 'id': id_subarea},
      success: function (data) {
          ...
          if(data.success == 'ok'){
            ...
            toastr.success('Se ha eliminado el usuario '+data.subarea);
          }
      }
    });
