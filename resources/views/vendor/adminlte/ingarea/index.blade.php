...
@section('title','Administrar Ingresos por Área')
@section('content_header','Administrar Ingresos por Área')
@section('content_description','Almacena los ingresos por área registrados')
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <p>¿Está seguro de eliminar Ingreso <b><span id="name-destroy"></span></b>?</p>
        </div>
