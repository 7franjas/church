...
@section('title','Crear Nuevo Ingreso por Area')
@section('content_header','Crear Nuevo Ingreso por Area')
@section('content_description','Registra la información del ingreso por area')
    ...
    <div class="col-md-9">
      <div class="box box-primary">
        ...
        <div class="box-header with-border box-header-color">
          <h3 class="box-title">Registrar Información | Ingreso por Area</h3>
        </div>

        <div class="box-body">
          <div class="form-container">

            <form action="{{ route('ingarea.store') }}" method="POST">

              {{ csrf_field() }}

              <div class="field {{ $errors->has('area_name') ? 'has-error' : '' }}">
                <div class="input-group">
                  <input id="area_name" name="area_name" type="text" class="form-control form-data" placeholder="Area" value="{{ old('area_name') }}" autofocus="autofocus">
              ...
              <div class="field {{ $errors->has('brother_name') ? 'has-error' : '' }}">
                <div class="input-group">
                  <input id="brother_name" name="brother_name" type="text" class="form-control form-data" placeholder="Nombre" value="{{ old('brother_name') }}" autofocus="autofocus">
                  <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                </div>
              ...
              <div class="field {{ $errors->has('monto') ? 'has-error' : '' }}">
                <div class="input-group">
                  <input id="monto" name="monto" type="monto" class="form-control form-data" placeholder="Monto" value="{{ old('monto') }}">
              ...
              <div class="field {{ $errors->has('tipo') ? 'has-error' : '' }}">
                  <div class="input-group">
                    <select id="type" name="type" class="form-control form-data select-form">
                      ...
                      <option {{ old('type')=='Ofrenda' ? 'selected' : '' }} value="Ofrenda">Ofrenda</option>
                      <option {{ old('type')=='Devolución' ? 'selected' : '' }} value="Devolución">Devolución</option>
              ...
              <div class="field {{ $errors->has('date') ? 'has-error' : '' }}">
                <div class="input-group">
                  <input id="datepicker"  id="date" name="date" type="fecha" class="form-control form-data" placeholder="Fecha" value="{{ old('date') }}">
                  <span class="input-group-addon"><i class="glyphicon glyphicon-envelope"></i></span>
                </div>
              ...
              <input id="brother_id" name="brother_id" type="hidden">
