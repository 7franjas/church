    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-header">
          ...
          <h4 class="modal-title">Eliminar Hermano(a)</h4>
        </div>
        <div class="modal-body">
          <p>¿Está seguro de eliminar Hermano(a) <b><span id="name-destroy"></span></b>?</p>
        </div>
...
<script>
  ...
  $('#submitDestroy').click(function(){
    ...
    ajax_destroy = 'brothers/destroy';
    id_brother = $("#modal-destroy #id-destroy").val();
    ...
    $.ajax({
      url: ajax_destroy,
      type: 'POST',
      data: {'_token': '{{ csrf_token() }}', '_method': 'DELETE', 'id': id_brother},
      success: function (data) {
          ...
          if(data.success == 'ok'){
            ...
            toastr.success('Se ha eliminado el usuario '+data.brother);
          }
      }
    });
