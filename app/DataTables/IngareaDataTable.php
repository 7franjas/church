...
class IngareaDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        ...
        return $dataTable->addColumn('action', function($query){
            return  '<a href="'.route("ingarea.show", $query->id).'" class="label label-success action-show" title="Ver"><i class="fa fa-eye"></i></a>'.
                    '<a href="'.route("ingarea.edit", $query->id).'" class="label label-warning action-edit" title="Editar"><i class="fa fa-edit"></i></a>'.
    ...
    public function query(Ingreso $model)
    {
        ...
        $ingreso = $model->where('typeIng', 3)->select();
    ...
    protected function getColumns()
    {
        ...
        return [
            ...
            'brother_id' => ['name'=>'brother_id', 'data'=>'brother_id', 'title'=>'Hermano', 'visible'=>true],
            'type' => ['name'=>'type', 'data'=>'type', 'title'=>'Tipo Ingreso', 'visible'=>true],
